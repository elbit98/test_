...
Route::group(['prefix' => 'agent','middleware' => ['auth', 'agent|salesman'] ], function() {
    ...
    Route::get('test', ['as' => 'agent.test.index', 'uses' => 'Agent\TestController@index']);
    Route::get('test/getAdditionalData/{id}', ['as' => 'agent.test.getAdditionalData', 'uses' => 'Agent\TestController@getAdditionalData']);
